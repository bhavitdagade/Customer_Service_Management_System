...
<body>
 ...
 <nav class="navbar navbar-expand-sm navbar-dark bg-success pl-5 fixed-top">
  ...
  <span class="navbar-text">Satisfaction of Customer is our Aim</span>
 ...
 <header class="jumbotron back-image" style="background-image:url(images/serviceman1.jpg);">
  <div class="myclass mainHeading">
   <h1 class="text-uppercase text-dark font-weight-bold">Welcome to CSMS</h1>
   <p class="font-italic">Customer's Satisfaction is our Aim</p>
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 1st Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Atharv Pawar</h4>
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 2nd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Paritosh Sharma</h4>
        <p class="card-text">Awesome and fast service</p>
       </div>
      </div>
     </div> <!-- End 2nd Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 3rd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Gaurav Borse</h4>
        <p class="card-text">Will recommend my friends.</p>
       </div>
      </div>
     </div> <!-- End 3rd Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 4th Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Jyoti Mane</h4>
        <p class="card-text">Hassle free experience.</p>
       </div>
      </div>
     </div> <!-- End 4th Column -->
    </div>
 ...
 <!-- Start Footer -->
 <footer class="container-fluid bg-success mt-5 text-white">
  <div class="container">
   <div class="row py-3">
